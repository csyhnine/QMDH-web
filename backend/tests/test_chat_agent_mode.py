...
class ChatAgentModeTests(unittest.TestCase):
    ...
    @patch("app.routers.chat.pack_chat_context")
    ...
    def test_agent_mode_false_uses_plain_chat_stream(
        ...
        mock_pack_chat_context,
    ) -> None:
        async def fake_packed(*_args, **_kwargs):
            from app.services.chat_context import PackedChatContext
        ...
        mock_pack_chat_context.side_effect = fake_packed
        ...
        mock_pack_chat_context.assert_called_once()
